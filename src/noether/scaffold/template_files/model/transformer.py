...
import torch
from __PROJECT__.schemas.models.transformer_config import TransformerConfig
...
class Transformer(BaseModel):
    ...
    Args:
        BaseModel: Base model class that contains the utilities for all models we use in this __PROJECT__.
    """
