...
class CompositeTransformerBlockConfig(ModelBaseConfig):
    kind: Literal["examples.tutorial.models.composite_components.CompositeTransformerBlockModel"] = (
        "examples.tutorial.models.composite_components.CompositeTransformerBlockModel"
    )
    depth: int
...
class CompositeTransformerConfig(ModelBaseConfig):
    kind: str = "examples.tutorial.models.composite_transformer.CompositeTransformer"
