...
def build_dataset_config(
    ...
    return StandardDatasetConfig(
        ...
        pipeline=AeroCFDPipelineConfig(
            kind="examples.tutorial.pipeline.AeroMultistagePipeline",
...
def build_model_config(
    ...
    model_config = UPTConfig(
        kind="examples.tutorial.model.UPT",
        name="upt",
        hidden_dim=192,
...
def build_trainer_config(model_forward_properties: list[str]) -> AutomotiveAerodynamicsCfdTrainerConfig:
    ...
    return AutomotiveAerodynamicsCfdTrainerConfig(
        kind="examples.tutorial.trainers.AutomotiveAerodynamicsCFDTrainer",
        surface_weight=1.0,
        volume_weight=1.0,
        ...
        callbacks=[
            ...
            # test loss
            SurfaceVolumeEvaluationMetricsCallbackConfig(
                kind="examples.shared.cfd_automotive.callbacks.SurfaceVolumeEvaluationMetricsCallback",
                batch_size=batch_size,
                every_n_epochs=loss_and_log_every_n_epochs,
                dataset_key="test",
                forward_properties=model_forward_properties,
